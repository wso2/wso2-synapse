...
public class GetChildrenWithAttributeParserComponent extends ParserComponent {
    ParserComponent nextParserComponent;
    String localName;
    String nameSpacePrefix;
    QName attributeQName;

    public GetChildrenWithAttributeParserComponent(String localName, String nameSpacePrefix) {
