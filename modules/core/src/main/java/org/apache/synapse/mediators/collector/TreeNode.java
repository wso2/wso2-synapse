...
public class TreeNode implements Cloneable {
	...
	private SuperMediator contents;
	 ...
	 *
	 * @param node      that is subjected for cloning
	 * @param messageID of the new Tree
	 ...
	 *
	 * @param childMediator the node that is to be added as the child
	 */
	 ...
	 *
	 * @param node of whose data is being printed on the cosole at the moment
	 */
	 ...
	 *
	 * @param node that is been executed according to the configuration
	 */
