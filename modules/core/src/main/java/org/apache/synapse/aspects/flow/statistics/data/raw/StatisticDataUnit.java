...
public class StatisticDataUnit {
	...
	public StatisticDataUnit(String statisticId, String componentId, ComponentType componentType, String parentId,
		...
		if (RuntimeStatisticCollector.isCollectingPayloads() && shouldCaptureTracing(messageContext) &&
		    isAlteringContent) {
			try {
	...
	public StatisticDataUnit(String statisticId, String componentId, String parentId, int cloneId, boolean isResponse,
	                         SynapseEnvironment synapseEnvironment, MessageContext messageContext) {
	...
	public void setAggregatePoint(boolean isAggregatePoint) {
		this.aggregatePoint = isAggregatePoint;
	}
	...
	public void setClonePoint(boolean isClonePoint) {
		this.clonePoint = isClonePoint;
	}
