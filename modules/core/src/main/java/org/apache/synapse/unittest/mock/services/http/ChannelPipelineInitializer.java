...
import org.apache.synapse.unittest.mock.services.http.consumer.HttpResponseProcessHandler;
...
public class ChannelPipelineInitializer extends ChannelInitializer<SocketChannel> {
    ...
    private void initializeHttpProducerChannel(SocketChannel ch) {
        ...
        pipeline.addLast(new org.apache.synapse.unittest.mock.services.http.producer.
