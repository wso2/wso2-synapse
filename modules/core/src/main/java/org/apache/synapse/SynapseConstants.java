...
public final class SynapseConstants {
    ...
    public static final String SYNAPSE_ARTIFACT_GROUP_ID = "synapse.artifact.group.id";
    public static final String SYNAPSE_ARTIFACT_ARTIFACT_ID = "synapse.artifact.artifact.id";
    public static final String SYNAPSE_ARTIFACT_VERSION = "synapse.artifact.version";
