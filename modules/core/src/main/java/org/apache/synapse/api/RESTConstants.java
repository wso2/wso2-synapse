...
public class RESTConstants {
    ...
    public static final String REST_URL_PATTERN = "api.url.pattern";
    ...
    public static final String CORS_CONFIGURATION_ENABLED = "synapse.api.CORSConfig.enabled";
    // List of allowed origins (comma separated)
    public static final String CORS_CONFIGURATION_ACCESS_CTL_ALLOW_ORIGIN =
                                                                "synapse.api.CORSConfig.Access-Control-Allow-Origin";
    // List of allowed headers (comma separated)
    public static final String CORS_CONFIGURATION_ACCESS_CTL_ALLOW_HEADERS =
                                                                "synapse.api.CORSConfig.Access-Control-Allow-Headers";

    /**
     * Constant prefix for api related internal properties
     */
