...
public final class MessageConverter {
	...
	private static final String RABBIT_PRIORITY = "RABBIT_PRIORITY";
		...
		try {
			...
			if (axis2Msg.getJsonStream() != null) {
				JsonUtil.newJsonPayload(axis2Ctx,
				                        new ByteArrayInputStream(axis2Msg.getJsonStream()), true,
				                        true);
			}
	...
	public static AMQPStorableMessage toStorableMessage(MessageContext synCtx) {
		...
		if (synCtx instanceof Axis2MessageContext) {
			...
			while (abstractMCProperties.hasNext()) {
				...
				if (RABBIT_PRIORITY.equals(propertyName)) {
	...
	private static Map<String, String> getTransportHeaders(
			org.apache.axis2.context.MessageContext messageContext) {
		Object headers = messageContext
	...
	private static void setTransportHeaders(org.apache.axis2.context.MessageContext msgCtx,
	                                        Map headers) {
