 ...
 * queue.
 */
public class MessageDataStore3 implements Runnable {

	private static Log log = LogFactory.getLog(MessageDataStore3.class);

	private BlockingQueue<StatisticsReportingEvent> queue;

	public MessageDataStore3(int queueSize) {
