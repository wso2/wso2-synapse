 ...
 *
 */
public abstract class ScheduledMessageProcessor extends AbstractMessageProcessor implements
                                                                                TaskManagerObserver {
    ...
    private boolean isPinnedServer(String serverName) {
        ...
        if (pinnedServersObj != null && pinnedServersObj instanceof String) {
            ...
            if (!pinned) {
                logger.info("Message processor '" + name + "' pinned on '" + pinnedServers +
                            "' not starting on" + " this server '" + serverName + "'");
            }
        } else {
