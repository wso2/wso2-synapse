...
public class EndpointEvent implements StatisticsReportingEvent {
	...
	public EndpointEvent(MessageContext messageContext, String endpointId, String endpointName, boolean isCreateLog) {
