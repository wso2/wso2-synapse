    ...
    public OMElement processDocument(InputStream inputStream, String s,
        ...
        if (inputStream != null) {
            ...
            if (endpointReference == null) {
                logger.error("#processDocument. Cannot build payload without a valid EPR. MessageID: " +
                             messageContext.getMessageID());
            ...
            try {
                ...
                logger.error("#processDocument. Could not decode request URL. MessageID: " +
                             messageContext.getMessageID());
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("#processDocument. No JSON payload found in request. MessageID: " +
                         messageContext.getMessageID());
        }
        return envelope;
    }
