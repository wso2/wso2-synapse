...
/**
 * This class tests the PassThroughHttpSender class.
 */
...
public class PassThroughHttpSenderTest extends TestCase {
    ...
    /**
     * This method tests the initialization of the PassThroughHttpSender.
     * @throws Exception
     */
    @Test
    ...
    /**
     * Method that tests the invoke method when the endpoint reference is given in the message context.
     * @throws Exception
     */
    @Test
    ...
    /**
     * Method that tests submitting response when source request is null.
     * @throws Exception
     */
    @Test
