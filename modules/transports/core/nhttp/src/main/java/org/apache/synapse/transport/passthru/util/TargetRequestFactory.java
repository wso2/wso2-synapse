...
public class TargetRequestFactory {
    ...
    public static TargetRequest create(MessageContext msgContext, HttpRoute route,
        ...
        try {
            ...
            Boolean noEntityBody =
                                   (Boolean) msgContext.getProperty(PassThroughConstants.NO_ENTITY_BODY);
            ...
            TargetRequest request =
                                    new TargetRequest(configuration, route, url, httpMethod,
            ...
            if (cType != null && (!httpMethod.equals("GET") && !httpMethod.equals("DELETE"))) {
                ...
                if (messageType != null) {
                    ...
                    final Pipe pipe =
                                      (Pipe) msgContext.getProperty(PassThroughConstants.PASS_THROUGH_PIPE);
                    if (pipe != null) {
                        builderInvoked =
                    ...
                    if (builderInvoked &&
                        (((messageType.indexOf(HTTPConstants.MEDIA_TYPE_MULTIPART_RELATED) != -1) || (messageType.indexOf(HTTPConstants.MEDIA_TYPE_MULTIPART_FORM_DATA) != -1)))) {
                        request.addHeader(HTTP.CONTENT_TYPE, cType);
                    }
            ...
            // version
            String forceHttp10 =
                                 (String) msgContext.getProperty(PassThroughConstants.FORCE_HTTP_1_0);
            ...
            // chunk
            String disableChunking =
                                     (String) msgContext.getProperty(PassThroughConstants.DISABLE_CHUNKING);
    ...
    private static String getContentType(MessageContext msgCtx) throws AxisFault {
        ...
        if (formatter != null) {
            ...
            if (contentType != null) {
                ...
                return new SOAPMessageFormatter().getContentType(msgCtx, format,
     ...
     * @param e
     *            original exception leads to the error condition
